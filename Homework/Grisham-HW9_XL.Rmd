...
hist2 <- ggplot(data = salary_ps2,
  ...
  geom_histogram(color = "white",
                 bins = 50) +        #XL: it was requested to use bins = 30
  scale_x_log10() +
  theme_bw() +
...
sal_simulate <- tibble(x = rlnorm(n = length(salary_ps2$salary),       #XL: you misses some codes. Where did fit.lnorm come from?
